...
import { VercelRequest, VercelResponse, CorsHandler } from "../types";
...
const handler = async (
    ...
    const response = {
        ...
        version: "1.0.0",
        description:
            "A wrapper API for Dify chatbot services, deployed on Vercel",
        documentation: {
            endpoints: {
                chat: {
                    ...
                    example: {
                        request: {
                            ...
                            conversation_id:
                                "1c7e55fb-1ba2-4e10-81b5-30addcea2276",
                            user_id: "user123",
                        },
                        response: {
                            success: true,
                ...
                completion: {
                    ...
                    parameters: {
                        ...
                        user_id:
                            'string (optional) - User identifier (default: "default-user")',
                        response_mode:
                            'string (optional) - "blocking" or "streaming" (default: "blocking")',
                    },
                    example: {
                        request: {
        ...
        links: {
            github: "https://github.com/onaka-yurusugi/dify-api-wrapper",
            dify_docs:
